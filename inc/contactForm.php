...
// 
$siteOwnersEmail = 'melvin@graphemas.com';
...
if($_POST) {
    ...
    if (strlen($subject) < 15) {
        $error['subject'] = "Por favor ingresa un tema o motivo de tu mensaje.";
    }
    // Subject
    if ($subject == 'subject') { $subject = "Formulario de contacto de envío"; }
    ...
    if (!$error) {
        ...
        if ($mail) { echo "OK"; }
        else { echo "Algo inesperado ocurrió. Inténtalo nuevamente."; }
